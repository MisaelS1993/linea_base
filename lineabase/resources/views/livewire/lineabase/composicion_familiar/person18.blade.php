...
<div class="col-md-6 col-12">
    <div class="form-group">
        <label for="loan">Ha obtenido un prestamo</label>
        <select class="form-control @error('people.' . $index . '.loan') is-invalid @enderror" id="loan"
            wire:model="people.{{ $index }}.loan" required>
            <option value="">Seleccione...</option>
            <option value="1">1.-Si</option>
            <option value="2">2.-No</option>
            <option value="3">3.-NS/NR</option>
        </select>
        @error('people.' . $index . '.loan')
            <div class="invalid-feedback">
                {{ $message }}
            </div>
        @enderror
...
<div class="col-md-6 col-12">
    <div class="form-group">
        <label for="consignment">Cuanto recibe de remesa</label>
        <select class="form-control @error('people.' . $index . '.consignment') is-invalid @enderror" id="consignment"
            wire:model="people.{{ $index }}.consignment" required>
            <option value="">Seleccione...</option>
            <option value="1">1.- No Recibe</option>
            <option value="2">2.- L.0.01 a L.1,000.00</option>
            <option value="3">3.- L.1,000.01 a L.2,000.00</option>
            <option value="4">4.- L.2,000.01 y más</option>
            <option value="5">5.- NS/NR</option>
        </select>
        @error('people.' . $index . '.consignment')
            <div class="invalid-feedback">
                {{ $message }}
            </div>
        @enderror
...
<div class="col-md-6 col-12">
    <div class="form-group">
        <label for="planification">Que método de planificación de familia utiliza</label>
        <select class="form-control @error('people.' . $index . '.planification') is-invalid @enderror" id="planification"
            wire:model="people.{{ $index }}.planification" required>
            <option value="">Seleccione...</option>
            ...
            <option value="5">5.-Preservativo (Condón)</option>
        ...
        @error('people.' . $index . '.planification')
            <div class="invalid-feedback">
                {{ $message }}
            </div>
        @enderror
