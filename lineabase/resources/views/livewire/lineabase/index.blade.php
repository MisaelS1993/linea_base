        ...
        <div class="card">
            <div class="card-header">
                <div style="text-align: right;">
                    <a href="{{ route('lineabase.create') }}" class="btn btn-primary btn-sm round">
                ...
                <div class="dataTable-wrapper dataTable-loading no-footer sortable searchable fixed-columns">
                    <div class="dataTable-top">
                        ...
                        <div class="dataTable-search"><input class="dataTable-input" placeholder="Search..."
                                type="text" _mstplaceholder="99723"></div>
                    </div>
                    <div class="dataTable-container">
                        <table class="table table-striped dataTable-table" id="table1">
                            <thead>
                                <tr>
                                    <th data-sortable="" style="width: 21.7521%;"><a href="#"
                                            class="dataTable-sorter">Name</a></th>
                                    <th data-sortable="" style="width: 55.7917%;"><a href="#"
                                            class="dataTable-sorter">Email</a></th>
                                    <th data-sortable="" style="width: 19.7596%;"><a href="#"
                                            class="dataTable-sorter">Phone</a></th>
                                    <th data-sortable="" style="width: 24.907%;"><a href="#"
                                            class="dataTable-sorter">City</a></th>
                                    <th data-sortable="" style="width: 20.7558%;"><a href="#"
